...
ADAPTIVE_THRESH_BLOCK_SIZE = 0
ADAPTIVE_THRESH_WEIGHT = 0
MIN_NUMBER_OF_MATCHING_CHARS = 0
...
def main(x,x1,x2,n):
    ...
    if blnKNNTrainingSuccessful == False:
        ...
        return
    global ADAPTIVE_THRESH_BLOCK_SIZE
    global ADAPTIVE_THRESH_WEIGHT
    global MIN_NUMBER_OF_MATCHING_CHARS
    ADAPTIVE_THRESH_BLOCK_SIZE = x1
    ADAPTIVE_THRESH_WEIGHT = x2
    MIN_NUMBER_OF_MATCHING_CHARS = n
    imgOriginal = x
